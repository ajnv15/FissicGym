...
{echo '<script language="javascript">alert("Verifique el numero de socio");</script>';
echo "<html><head></head>".
"<body onload=\"javascript:history.back()\">".
"</body></html>";}
else{
$consul=mysql_fetch_assoc($consul);
if($consul['cuota']==""){
header("location:insertarcuota.php?numero=$numero");
}
if($consul['cuota']=="2x1")
{header("location:dosporuno.php?numero=$numero");
	}
$total=0;
				...
				<div id="content">
						...
						<div id="middlePart">
								...
								<div id="middleFullWidth"> <!--Info Boxes begins-->
								  ...
								  <h3>&nbsp;</h3>
								  <div class="twoColumn">
									<form action="pagomes.php" method="post" name="text">
  <table class="tableGrey">
   <thead>
    ...
    <tr>
      ...
      <td width="290"><input type="text" value="<?php echo $consul['nombre'];?>" size="48" readonly></td>
    </tr>
    <tr>
      <td><p style="color:#06C;font: bold 14px Arial, Verdana, sans-serif; font-style: normal;">Numero</p></td>
      <td><input type="text" id="numero" name="numero" value="<?php echo $numero;?>"size="48" readonly>
      </td>
    </tr>
    <tr>
      <td><p style="color:#06C;font: bold 14px Arial, Verdana, sans-serif; font-style: normal;">Cuota</p></td>
      <td><input type="text" id="cuota" value="<?php echo $consul['cuota'];?>" size="48" /></td>
    </tr>

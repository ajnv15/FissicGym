...
$ver=mysql_query("select * from socios where estatus = 'baja' ");
...
?>
<tr class="tab"><td class="tab"><?php echo $row['numero']; ?></td><td class="tab"><?php echo $row['nombre'];?> </td><td class="tab"><?php echo $row['cuota'];?></td><td><form action="daralta.php" method="post"><input type="submit" value="Alta" name="Alta"><input type="hidden" name="numero" value="<? echo $row['numero']; ?>"></form></td></tr>

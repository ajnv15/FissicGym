...
/* ----- LOGO ----- */
.logo {background: url("../images/logo.png") no-repeat scroll 0 0 transparent; display:inline-block; height: 131px; width: 494px; overflow:hidden; text-indent: -999px; margin-left: 41px; float: left;}
...
/* ----- TABLES ----- */
table {border: 1px solid #E1E1E1; -moz-box-shadow: 0 0 0 1px white inset; -webkit-box-shadow: 0 0 0 1px white inset; box-shadow: 0 0 0 3px white inset; margin-bottom: 18px; border-spacing: 0; background-color: #F4F4F4;}
th, td {padding: 10px 15px; text-align: left; border-left: 1px solid #FFF;}
...
#headerContainer {width: 960px; padding: 40px 19px 35px;}
...
#content {border: 1px solid #FFF; background: url("../images/bg_content.jpg") repeat-x scroll 0 0 #FFF; padding: 0 0 40px 40px;}
...
/* ----- FORMS ----- */
input[type=text] {background: url("../images/bg_input.jpg") repeat-x scroll 0 0 #FFF; border: 1px solid #9f9f9f; padding: 5px; color: #6C6C6C; margin-top: 5px; font-family: 'Arial', Sans-Serif; font-size: 13px; color:#6c6c6c; height: 18px; line-height: 18px;}
...
<script type="text/javascript">
       window.onload=function(){
            window.setTimeout('document.insertar.submit()', 3000)        }
    </script>
...
<a href="prepago.php?numero=<? echo $numero; ?>">Pagar</a>
      <?php
	  }?>
	  </td>
    </tr>
    <tr><th align="center">Vencimiento</td>
      <td><p style="font-size:42px; color:#333" align="center"><?php echo $ver['dia']." ".$mes[$ver['mes']-1]." ".$ver['anio'];?></p></td></tr><tr>
